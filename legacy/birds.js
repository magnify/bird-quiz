...
// Manual image overrides for species where the automatic Wikipedia/Commons
// pipeline returns bad images (maps, eggs, specimens, wrong species, etc.)
const IMAGE_OVERRIDES = {
  ...
  // Forest birds — treecreepers, thrushes
